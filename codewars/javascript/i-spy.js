/*
  Level: 5 kyu
  Link: https://www.codewars.com/kata/555185132c0d4cca3d000197
  Instructions: 
...
function spyOn (func) {
  ...
  innerFunc.callCount = () => callCount;
  innerFunc.returned = (result) => results.includes(result);
  innerFunc.wasCalledWith = (param) => parameters.includes(param);
