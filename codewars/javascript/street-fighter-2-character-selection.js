/*
  ...
  Instructions: 
    ...
    all the moves (ordered and with repetition, all the ones after a move, wether 
    ...
    row: Ken, Chun Li, Zangief, Dhalsim, Sagat and M.Bison in the above image; you 
    can't go upper than highest row: Ryu, E.Honda, Blanka, Guile, Balrog and Vega in 
    the above image).
...
function streetFighterSelection(fighters, position, moves){
  const selection = [];
  const height = fighters.length - 1;
  const width = fighters[height].length - 1;
